...
v1.2 换的是**构图语法**：敦煌壁画怎么组织一面墙，这个面板就怎么组织。

| 壁画的构件 | 界面里对应什么 |
|---|---|
| **藻井**（窟顶中心） | 顶栏：一枚放大的藻井团花虚压中轴，标题与按钮**完全轴对称** |
| **佛龛**（拱顶小龛） | 每行文件图标的容器 —— 拱形龛，不再是圆角方块 |
| **贴金**（给造像上金箔） | **进度**：金箔从龛底涌起，涌到的高度就是进度，镀满即完成 |
| **榜题**（给每铺画挂的标牌） | 分组头：土红底 + 金边的标牌，件数是一枚小金印 |
| **木签** | 筛选标签 |
| **卷草 / 飘带** | 顶栏底边的金飘带界栏 |
...
## 文件结构
    ...
    popup.css            「敦煌·石窟」主题：藻井顶栏 / 佛龛贴金 / 榜题 / 深色模式
